from numpy import random # You can introduce more randomness in the fighting logic 
...
class Driver:
    ...
    def startBattle(self, character_name):
        self.characters = [ElderlyCivilian(1, 1), Warrior(1, 1, character_name), Veteran(1, 1)]
