...
class GameApp(tk.Tk):
    def __init__(self):
        ...
        # Add a label and an entry widget to input the character's name
        self.name_label = tk.Label(self, text="Enter your character's name:")
        self.name_label.pack(pady=(5, 0), in_=self.text_frame)
        self.name_entry = tk.Entry(self)
        self.name_entry.pack(pady=(0, 10), in_=self.text_frame)
    ...
    def toggle_battle(self):
        ...
        if not self.battle_started:
            ...
            self.start_battle(character_name)
        else:
            self.reset_game(character_name)

    def start_battle(self, character_name):
        self.driver.startBattle(character_name)
    ...
    def reset_game(self, character_name):
